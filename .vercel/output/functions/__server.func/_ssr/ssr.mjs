...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-no-H6gj7.mjs");
...
var manifest = { "29b8cab67d2eb6de95ec29ee4457dbc6f42911c0e50f778cac9a3e3299c1d780": {
	functionName: "submitLead_createServerFn_handler",
	importer: () => import("./submit-lead-BMfDZ2bu.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DoP7_eiI.mjs").then((n) => n.t),
